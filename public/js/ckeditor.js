...
(function() {
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			createClass: function(a) {
				...
				e && (b.prototype = this.prototypedCopy(e.prototype), b.prototype.constructor = b, b.base = e, b.baseProto = e.prototype, b.prototype.base = function() {
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (e)
							for (var w = 0; w < e.length; w++) b.push([a, c[d], e[w]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
					...
					for (v = this, m = null; v && "body" != v.getName() && "html" != v.getName();) {
				...
				document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || w || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
				return {
					x: b,
					y: c
				}
	...
	(function() {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				...
				this._.guardLTR = function(a, b) {
					return (!b || !L.equals(a)) && (!D || !a.equals(D)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			...
			this.current ? e = this.current[C](!1, r, g) : (a ? e.type == CKEDITOR.NODE_ELEMENT && (e = 0 < x ? e.getChild(x - 1) : !1 === g(e, !0) ? null : e.getPreviousSourceNode(!0, r, g)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, r, g)))), e && !1 === g(e) && (e = null));
			for (; e && !this._.end;) {
				this.current = e;
		...
		CKEDITOR.dom.walker.bogus = function(a) {
			...
			return function(c) {
				...
				e && (e = c.getParent(), c = c.getNext(b), e = e.isBlockBoundary() && (!c || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary()));
				return !!(a ^ e)
			}
		};
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && e(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, f) {
			...
			function h() {
				var b = K - 1,
					c = E && y && !r.equals(C);
				b < B - 1 || b < A - 1 || c ? (c ? a.moveToPosition(C, CKEDITOR.POSITION_BEFORE_START) : A == b + 1 && t ? a.moveToPosition(l[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(l[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = O[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
					startNode: c
				}))) : a.collapse(!0)
			}
			a.optimizeBookmark();
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark2: function() {
				function a(b) {
					...
					m = e;
					var f = d;
					m = m.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == m.getChildCount() ? 0 : m.getChild(f - 1).type == CKEDITOR.NODE_TEXT && m.getChild(f).type == CKEDITOR.NODE_TEXT;
					...
					if (e.type == CKEDITOR.NODE_TEXT) {
						...
						m = f;
						e.getText() ? d += m : (f = e.getPrevious(c), m ? (d = m, e = f ? f.getNext() : e.getParent().getFirst()) : (e = e.getParent(), d = f ? f.getIndex(!0) + 1 : 0))
					}
					b.container = e;
					b.offset = d
				}
			...
			enlarge: function(a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						D.type == CKEDITOR.NODE_TEXT ? (t && (D = !CKEDITOR.tools.trim(D.substring(0, t)).length && D, L = !!D), D && ((r = D.getPrevious()) || (n = D.getParent()))) : (t && (r = D.getChild(t - 1) || D.getLast()), r || (n = D));
						for (n = c(n); n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
						...
						n = r = null;
						C = L = !1;
						D.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(D.substring(t)).length ? L = !0 : (L = !D.getLength(), t == D.getLength() ? (r = D.getNext()) || (n = D.getParent()) : g(D, t) && (n = D.getParent())) : (r = D.getChild(t)) || (n = D);
						for (; n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
								if (f ? n.isBlockBoundary() : !h.contains(n)) break;
			...
			shrink: function(a, b, c) {
				...
				if (!this.collapsed) {
					...
					n && (g.reset(), (g = g[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(g, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
					return !(!c && !n)
				}
			},
			...
			splitBlock: function(a, b) {
				...
				this.deleteContents();
				f && f.equals(g) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END), g = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (g = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
				return {
					previousBlock: f,
					nextBlock: g,
					wasStartOfBlock: c,
			...
			removeEmptyBlocksAtEnd: function() {
				function a(e) {
					return function(a) {
						return b(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.isEmptyInlineRemoveable() || e.is("table") && a.is("caption") ? !1 : !0
					}
				}
				var b = CKEDITOR.dom.walker.whitespaces(),
					c = CKEDITOR.dom.walker.bookmark(!1);
			...
			_find: function(a, b) {
				...
				if (c && c.find)
					for (m = c.find(a), g = 0; g < m.count(); g++)
						if (c = m.getItem(g), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), h && k && f.push(c);
				return f
			}
		};
	...
	(function() {
		...
		function b(a, c, f, g) {
			...
			if (!g) return 0;
			if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(c)) return b(a, c, f, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
				element: g.element,
				container: f,
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (g in P) {
					...
					for (; C = h.pop();) B[C] = B["!" + C], delete B["!" + C];
					r[t] = (A ? !1 : y) || null
				}
			...
			for (d = a.length; c < d; ++c) {
				...
				if (!0 === f.elements || null === f.elements) e[n ? "unshift" : "push"](f);
				else
					...
					if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
						...
						if (a)
							if (!0 === a) a = !0;
								...
								for (var f = 0, n = c.length, l; f < n; ++f) l = c[f], e[l] || (e[l] = a(l));
								a = !1
							}
						else a = !1;
						d.allClasses = a
		...
		function z(a, b, e, f) {
			...
			if (f.doFilter) {
				...
				if (!a || !a.valid) return e.push(b), 1;C = a.validAttributes;
				var h = a.validStyles;
				n = a.validClasses;
				var g = b.attributes,
					I = b.styles,
		...
		function H(a) {
			return a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || t.$block[a.name])
		}
		...
		CKEDITOR.filter = function(a, b) {
			...
			if (c && !b) {
				...
				!0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(I[c.enterMode] + " " + I[c.shiftEnterMode], "default", 1), this.disallow(c.config.disallowedContent))
		...
		CKEDITOR.filter.prototype = {
				...
				for (; y = a.pop();)
					if (c = y.el, c.parent) switch (k = t[c.parent.name] || t.span, y.check) {
						case "it":
							...
							break;
						case "el-up":
							c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name] || n(c, d, a);
							break;
						case "parent-down":
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						var f = void 0,
							...
							t = void 0;
						c = [];
						for (n = 0; n < b.length; ++n) l = b[n], "string" == typeof l ? (l = l.split(/\s*:\s*/), g = l[0], m = null, t = l[1]) : (g = l.check, m = l.left, t = l.right), f || (f = l, f = f.element ? f.element : g ? g.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element), m instanceof CKEDITOR.style && (m = D(m)), c.push({
							check: g == f ? null : g,
							left: m,
			...
			check: function(a, b, c) {
				...
				if (!1 !== b && (m = this._.transformations[f.name])) {
					for (d = 0; d < m.length; ++d) r(this, f, m[d]);
					v(f)
				}
				z(this, l, g, {
					doFilter: !0,
		...
		J = CKEDITOR.filter.transformationsTools = {
			...
			transform: function(a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (e in f)
						if ("class" == e)
							for (c = a.classes.join("|"), n = f[e].split(/\s+/); g = n.pop();) - 1 == c.indexOf(g) && a.classes.push(g);
	...
	(function() {
		function a(a, e, f) {
			...
			CKEDITOR.tools.setTimeout(function() {
				"destroyed" !== this.status ? h(this, a) : CKEDITOR.warn("editor-incorrect-destroy")
			}, 0, this)
		}
		...
		function x(a) {
			...
			CKEDITOR.plugins.load(d.split(","), function(b) {
				...
				for (var n in b) {
					...
					r && !a.lang[n] && (r.split && (r = r.split(",")), 0 <= CKEDITOR.tools.indexOf(r, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""), h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(r, h) ? h : 0 <= CKEDITOR.tools.indexOf(r, "en") ? "en" : r[0]), g.langEntries && g.langEntries[h] ? (a.lang[n] = g.langEntries[h], h = null) : f.push(CKEDITOR.getUrl(g.path + "lang/" + h + ".js")));
					e.push(h);
					d.push(g)
				}
			...
			F.onTagOpen = function(f, e, g, k) {
				...
				if (a(e)) m.push(e);
					...
					if ("br" == f) M.push(e);
						...
						else if (f in CKEDITOR.dtd.$listItem && !z(f, g)) F.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					p, q, e, x;
				for (x = 0; x < h; x++)
					if (d && (p = c.type, q = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll || a.nestedEditable && e.options.excludeNestedEditable)) {
	...
	(function() {
		function a(a, d) {
			...
			function l(a, d) {
				return function(f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (l = !a || !1 !== ("function" == typeof d ? d(f) : d)) y || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (l = b(f), l = !l || "form" == f.name && "input" == l.name) : l = !1 : l = !1;
						l && f.add(e(a))
					}
				}
			}
			...
			function t(a, b) {
				...
				var c;
				return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(u)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in B) || !y && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
			}
			var E = {
					elements: {}
				},
	...
	(function() {
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
			...
			k.setSize("width", a, !0);
			q && (q.style.width = "1%");
			var e = (k.$.offsetHeight || 0) - (p.$.clientHeight || 0),
	...
	(function() {
		function a(a) {
			...
			}, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), t = 1, a.cancel());
			t && h.select()
		}
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElementIntoRange: function(a, b) {
					...
					if (f)
						for (;
							(t = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[t.getName()]) && (!g || !g[e]);) t.getName() in CKEDITOR.dtd.span ? b.splitElement(t) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(t), b.collapse(!0), t.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
					b.insertNode(a);
					return !0
				},
				...
				setup: function() {
					...
					if (!this.is("textarea")) {
						...
						if (k) {
							...
							m ? k != m.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? m.$.styleSheet.cssText = k : m.setText(k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(k.ownerNode || k.owningElement), h.setCustomData("stylesheet", k), k.data("cke-temp", 1))
						}
						...
						a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) {
							b.data.getKeystroke() in t && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
						});
						...
						CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
							...
							if (c in t && (b = a.getSelection(), 0 !== b.getRanges().length)) {
								...
								else c = d, l = b.block, d = c.endPath().block, l && d && !l.equals(d) ? (a.fire("saveSnapshot"), (e = l.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(l, !1), b.lastElement.mergeSiblings(), q(l, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
								if (!b) return;
		...
		v = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var y = E[y.getName()], h = 0, I = c.getChildren(), m = I.count(), q = -1, p = -1, P = 0, D = e.contains(E.$list); h < m; ++h) e = I.getItem(h), a(e) ? (g = e.getName(), D && g in CKEDITOR.dtd.$list ? k = k.concat(b(e, d)) : (t = !!y[g], "br" != g || !e.data("cke-eol") || h && h != m - 1 || (P = (f = h ? k[h - 1].node : I.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != q || t || (q = h), t || (p = h), k.push({
					isElement: 1,
					isLineBreak: P,
			...
			function g(b, c, d, e) {
				...
				(t = (new CKEDITOR.dom.walker(f)).next()) && a(t) && y[t.getName()] && (k = t.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && e.contains(t) && t.isIdentical(k) && (t.moveChildren(k), t.remove(), g(b, c, d, e))
			}
			...
			return function(y, l, K, B) {
				...
				if (!B.checkReadOnly()) {
					...
					B = y.mergeCandidates;
					var q, p;
					"text" == y.type && l.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (q = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", l.document), l.insertNode(q), l.setStartAfter(q));
					...
					if (q = K) {
						...
						if ((v = q.startPath().block) && (1 != v.getChildCount() || !v.getBogus())) a: {
							var x;
					...
					if (q) {
						...
						var J = y.endPath.elements[0],
							W, G = J.getPosition(l),
							w = !!J.getCommonAncestor(l) && G != CKEDITOR.POSITION_IDENTICAL && !(G & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
						l = b(y.dataWrapper, y);
						for (t(l, x); B < l.length; B++) {
							...
							if (u) K = 0 < B;
								...
								u = x.startPath();
								!G.isBlock && k(y.editor, u.block, u.blockLimit) && (T = h(y.editor)) && (T = q.createElement(T), T.appendBogus(), x.insertNode(T), CKEDITOR.env.needsBrFiller && (z = T.getBogus()) && z.remove(), x.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
						...
						z && (K = !0, u = l[0].node, x.setStartAt(u, CKEDITOR.POSITION_BEFORE_START), x.setEndAt(u, CKEDITOR.POSITION_AFTER_END));
						y.dontMoveCaret = K;
					...
					if (!y.dontMoveCaret) {
						for (F = e(z); F && a(F) && !F.is(E.$empty);) {
							if (F.isBlockBoundary()) z.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
							else {
				...
				table: function() {
					function a(c) {
						...
						g.guard = function(a, g) {
							...
							if (g && k && a.equals(k)) f = c.clone(), f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(f);
								...
								if (A = !g) A = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
								if (!A && (A = g))
					...
					return {
						...
						detectRanges: function(e, f) {
							...
							l = l.contains("table");
							m = m.contains("table");
							if (l || m) l && m && b(l, m) ? (e.tableSurroundingRange = k, k.setStartAt(l, CKEDITOR.POSITION_AFTER_END), k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), k = g.clone(), k.setEndAt(l, CKEDITOR.POSITION_AFTER_END), h = g.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START), h = a(k).concat(a(h))) : l ? m || (e.tableSurroundingRange = k, k.setStartAt(l, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = k, k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), g.setStartAt(m, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = h ? h : a(g)
						},
	...
	(function() {
		...
		function g() {
			...
			c = this.elementPath();
			c.compare(this._.selectionPreviousPath) || (e = this._.selectionPreviousPath && this._.selectionPreviousPath.blockLimit.equals(c.blockLimit), !CKEDITOR.env.webkit && !CKEDITOR.env.gecko || e || (this._.previousActive = this.document.getActive()), this._.selectionPreviousPath = c, this.fire("selectionChange", {
				selection: b,
				path: c
			}))
		}
		...
		function v(a) {
			for (var b = 0; b < a.length; b++) {
				...
				if (!c.collapsed) {
					...
					e && e.type == CKEDITOR.NODE_TEXT && (l ? g.setEndAfter(e) : g.setEndBefore(e));
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				CKEDITOR.env.gecko && h.attachListener(h, "focus", function(a) {
					a.removeListener();
					0 !== q && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = c.createRange(), a.moveToElementEditStart(h), a.select())
				}, null, null, -2);
				...
				if (CKEDITOR.env.ie || E) m ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() {
					c.lockSelection(p);
					q = 1
				...
				h.attachListener(h, "touchstart", k, c);
				...
				var a = m ? function() {
					...
					var b = function(b, c) {
						...
						if (-1 == n || n == e.length - 1 && 0 > t) {
							...
							for (d = e.length; 0 < h && 0 < d;) g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (q = g, h -= g.nodeValue.length);
							return {
								container: q,
								offset: -h
							}
					...
					if (this.isLocked) {
						...
						if (l) this.fake(l);
							...
							if (m) {
								...
								if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in B || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in B) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed;
								G = b.createBookmark();
								B = G.startNode;
								a || (k = G.endNode);
								...
								k ? (l = b.document.$.body.createTextRange(), l.moveToElementText(k.$), G.setEndPoint("EndToEnd", l), G.moveEnd("character", -1)) : (A = B.getNext(p), J = B.hasAscendant("pre"), A = !(A && A.getText && A.getText().match(l)) && (J || !B.hasPrevious() || B.getPrevious().is && B.getPrevious().is("br")), J = b.document.createElement("span"), J.setHtml("\x26#65279;"), J.insertBefore(B), A && b.document.createText("﻿").insertBefore(B));
								b.setStartBefore(B);
								B.remove();
								...
								for (G = 0; G < a.length; G++) {
									if (G < a.length - 1 && (A = a[G], J = a[G + 1], l = A.clone(), l.setStart(A.endContainer, A.endOffset), l.setEnd(J.startContainer, J.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), b = l.getCommonAncestor(), l = l.getEnclosedNode(), b.isReadOnly() || l && l.isReadOnly()))) {
									...
									b.collapsed && CKEDITOR.env.webkit && q(b) && (l = e(this.root), b.insertNode(l), (A = l.getNext()) && !l.getPrevious() && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() ? (x(this.root), b.moveToPosition(A, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
				...
				for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					...
					if (r.equals(w)) r = null, m = !0;
						...
						var v = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
							...
							z = v && r.getAttribute("data-nostyle");
						...
						if (D)
							if (E = r.getParent(), D = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || D.parentRule && !D.parentRule(E)) m = !0;
							else {
					...
					if (m && x && !x.collapsed) {
						for (var m = M(this, e), u = m.hasAttributes(), z = x.getCommonAncestor(), v = {}, D = {}, E = {}, H = {}, U, R, aa; m && z;) {
							if (z.getName() == g) {
								for (U in h.attributes) !H[U] && (aa = z.getAttribute(R)) && (m.getAttribute(U) == aa ? D[U] = 1 : H[U] = 1);
		...
		function p(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : z.call(this, d));
			a.moveToBookmark(b)
		}
		...
		function z(a, b) {
			...
			v(a, e, D[a.getName()]);
			f && (this._.definition.alwaysRemoveElement ? m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
		}
		...
		CKEDITOR.style.prototype = {
			...
			removeFromRange: function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? p : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
		...
		CKEDITOR.dom.elementPath = function(b, f) {
			...
			do
				if (p.type == CKEDITOR.NODE_ELEMENT) {
					...
					if (p.equals(f)) break;
					if (!k && (q = p.getName(), "true" == p.getAttribute("contenteditable") ? k = p : !g && d[q] && (g = p), a[q])) {
						if (q = !g && "div" == q) {
							a: {
								q = p.getChildren();
	...
	*/
				...
				labeledElement: function(b, a, d, f) {
					if (!(4 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, e, function() {
							...
							"horizontal" != a.labelLayout ? e.push('\x3clabel class\x3d"cke_dialog_ui_labeled_label' + g + '" ', ' id\x3d"' + c.labelId + '"', c.inputId ? ' for\x3d"' + c.inputId + '"' : "", (a.labelStyle ? ' style\x3d"' + a.labelStyle + '"' : "") + "\x3e", a.label, "\x3c/label\x3e", '\x3cdiv class\x3d"cke_dialog_ui_labeled_content"', a.controlStyle ? ' style\x3d"' + a.controlStyle + '"' : "", ' role\x3d"presentation"\x3e', f.call(this, b, a), "\x3c/div\x3e") : (g = {
								type: "hbox",
								widths: a.widths,
								padding: 0,
								children: [{
									...
									type: "html",
									html: '\x3cspan class\x3d"cke_dialog_ui_labeled_content"' + (a.controlStyle ? ' style\x3d"' + a.controlStyle + '"' : "") + "\x3e" + f.call(this, b, a) + "\x3c/span\x3e"
								}]
	...
	(function() {
		...
		function Z(a) {
			function b(b) {
				...
				if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) n = Math.max(e.minWidth || 0, G - g);
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function d(b) {
				if (l == CKEDITOR.dialog._.currentTop) {
					...
					else if (-1 != CKEDITOR.tools.indexOf(g, c) && l._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? x.call(l) : A.call(l), l.selectPage(c), l._.tabs[c][0].focus(), q = 1;
			...
			this.on("show", function() {
				...
				a.config.dialog_startupFocusTab && b ? (l._.tabBarMode = !0, l._.tabs[l._.currentTabId][0].focus(), l._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length - 1, g.onFocus ? (b = g.onFocus.call(this)) && b.focus() : e(1))
		...
		CKEDITOR.dialog.prototype = {
			...
			show: function() {
				...
				this.reset();
				null === this._.currentTabId && this.selectPage(this.definition.contents[0].id);
	...
	(function() {
		...
		r.prototype = {
			...
			_layout: function() {
				...
				g && h || (m = this.element.getChild(0), g = this._notificationWidth = m.getClientRect().width, h = this._notificationMargin = parseInt(m.getComputedStyle("margin-left"), 10) + parseInt(m.getComputedStyle("margin-right"), 10));
		...
		CKEDITOR.ui.button.prototype = {
			render: function(a, b) {
				...
				if (this.directional) a.on("contentDirChanged", function(b) {
					...
					d.setAttribute("style", CKEDITOR.skin.getIconStyle(m, "rtl" == b, this.icon, this.iconOffset))
				}, this);
	...
	(function() {
		function D(a) {
			...
			function f() {
				...
				for (e in b) b[e] = b[e].sort(function(b, a) {
		...
		function x(a) {
			...
			function l(b, c) {
				...
				if (!d.getById("cke_pastebin")) {
					...
					var l = 0,
						d = d.getWindow();
					CKEDITOR.env.webkit ? (e.append(k), k.addClass("cke_editable"), e.is("body") || (l = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), l = l.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
					k.setStyles({
						position: "absolute",
					...
					(l = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-10000px");
			...
			a.getClipboardData = function(b, c) {
				...
				!1 === y() && (a.removeListener("paste", d), a._.forcePasteDialog && h && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", e), a.on("dialogHide", function(a) {
					a.removeListener();
		...
		function E(a) {
			...
			a.on("contentDom", function() {
				...
				e.attachListener(a, "dragstart", function() {
					...
					CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (b.dragStartContainerChildCount = c ? h(c.startContainer) : null, b.dragEndContainerChildCount = c ? h(c.endContainer) : null)
				}, null, null, 100);
				...
				e.attachListener(a, "drop", function(e) {
					if (e = e.data) {
						var h = e.dropRange,
							f = e.dragRange,
							g = e.dataTransfer;
						g.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function() {
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init: function(a) {
				...
				a.on("paste", function(b) {
					...
					if ("text" == d && "html" == g) f = w(a, f, c.get("plain-text"));
	...
	(function() {
		...
		var g = CKEDITOR.addTemplate("panel", '\x3cdiv lang\x3d"{langCode}" id\x3d"{id}" dir\x3d{dir} class\x3d"cke cke_reset_all {editorId} cke_panel cke_panel {cls} cke_{dir}" style\x3d"z-index:{z-index}" role\x3d"presentation"\x3e{frame}\x3c/div\x3e'),
					...
					if (!a) {
						if (this.isFramed) {
							...
							a.on("keydown", function(a) {
								...
								if ("input" !== a.data.getTarget().getName() || 37 !== b && 39 !== b) this._.onKeyDown && !1 === this._.onKeyDown(b) ? "input" === a.data.getTarget().getName() && 32 === b || a.data.preventDefault() : (27 == b || b == ("rtl" == c ? 39 : 37)) && this.onEscape && !1 === this.onEscape(b) && a.data.preventDefault()
							}, this);
							a = a.getBody();
							a.unselectable();
			...
			proto: {
				...
				onKeyDown: function(a, b) {
					...
					switch (e) {
						...
						case "click":
						case "mouseup":
							return d = this._.focusIndex, (c = 0 <= d && this._.getItems().getItem(d)) && (c.$[e] ? c.$[e]() : c.$["on" + e]()), !1
					}
					return !0
				}
			}
	...
	(function() {
		...
		var h = h + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e'),
			r = CKEDITOR.addTemplate("menuItem", h + '\x3cspan class\x3d"cke_menubutton_inner"\x3e\x3cspan class\x3d"cke_menubutton_icon"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{iconStyle}"\x3e\x3c/span\x3e\x3c/span\x3e\x3cspan class\x3d"cke_menubutton_label"\x3e{label}\x3c/span\x3e{shortcutHtml}{arrowHtml}\x3c/span\x3e\x3c/a\x3e\x3cspan id\x3d"{id}_description" class\x3d"cke_voice_label" aria-hidden\x3d"false"\x3e{ariaShortcut}\x3c/span\x3e\x3c/span\x3e'),
			...
			_: {
				...
				showSubMenu: function(a) {
					...
					if (d = d.getItems && d.getItems()) {
						...
						var k = this._.panel.getBlock(this.id).element.getDocument().getById(this.id + String(a));
						setTimeout(function() {
							b.show(k, 2)
						}, 0)
			...
			proto: {
				...
				show: function(a, b, d, m) {
					...
					for (var c = k.elementPath(), c = ['\x3cdiv class\x3d"cke_menu' + (c && c.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], h = g.length, n = h && g[0].group, q = 0; q < h; q++) {
						var p = g[q];
						n != p.group && (c.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), n = p.group);
						p.render(this, q, c)
					}
					c.push("\x3c/div\x3e");
					f.setHtml(c.join(""));
			...
			proto: {
				render: function(a, b, d) {
					...
					a = {
						...
						shortcutHtml: c ? n.output({
							shortcut: c.display
						}) : "",
						arrowHtml: u ? t.output({
							label: q
						}) : "",
			...
			CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({
				...
				proto: {
					...
					open: function(a, f, c, d) {
						!1 !== this.editor.config.enableContextMenu && this.editor.getSelection().getType() !== CKEDITOR.SELECTION_NONE && (this.editor.focus(), a = a || CKEDITOR.document.getDocumentElement(), this.editor.selectionChange(1), this.show(a, f, c, d))
					}
				}
			})
		},
		beforeInit: function(a) {
			...
			a.addCommand("contextMenu", {
				exec: function(a) {
					...
					if (b = b[b.length - 1]) d = b["rtl" === a.lang.dir ? "left" : "right"], e = b.bottom;
	...
	(function() {
		function q(a, c) {
			...
			var n = a.ui.spaceId("path"),
				...
				q = h.idBase;
			c.html += '\x3cspan id\x3d"' + n + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel + '\x3c/span\x3e\x3cspan id\x3d"' + n + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' + n + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';
			a.on("uiReady", function() {
			...
			a.on("selectionChange", function(b) {
				for (var e = [], g = h.list = [], d = [], c = h.filters, p = !0, k = b.data.path.elements, u = k.length; u--;) {
					var f = k[u],
						r = 0;
					b = f.data("cke-display-name") ? f.data("cke-display-name") : f.data("cke-real-element-type") ? f.data("cke-real-element-type") : f.getName();
		...
		CKEDITOR.plugins.enterkey = {
			enterBlock: function(a, e, b, g) {
				...
				if (b = b || y(a)) {
					b = z(b);
					var h = b.document,
						n = b.checkStartOfBlock(),
						f = b.checkEndOfBlock(),
						p = a.elementPath(b.startContainer),
						c = p.block,
						l = e == CKEDITOR.ENTER_DIV ? "div" : "p",
						d;
					if (n && f) {
						if (c && (c.is("li") || c.getParent().is("li"))) {
							...
							var f = !c.hasNext(),
								...
								n = l.createBookmarks(),
								k = c.getDirection(1),
								t = c.getAttribute("class"),
								q = c.getAttribute("style"),
								r = d.getDirection(1) != k;
							a = a.enterMode != CKEDITOR.ENTER_BR || r || q || t;
							if (d.is("li")) g || f ? (g && f && b.remove(), c[f ? "insertAfter" : "insertBefore"](d)) : c.breakParent(d);
							else {
								if (a)
									if (p.block.is("li") ? (d = h.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), r && d.setAttribute("dir", k), q && d.setAttribute("style", q), t && d.setAttribute("class", t), c.moveChildren(d)) : d = p.block, g || f) d[g ? "insertBefore" : "insertAfter"](b);
									else c.breakParent(b), d.insertAfter(b);
								else if (c.appendBogus(!0), g || f)
									for (; h = c[g ? "getFirst" : "getLast"]();) h[g ? "insertBefore" : "insertAfter"](b);
								else
									for (c.breakParent(b); h = c.getLast();) h.insertAfter(b);
								c.remove()
							}
							l.selectBookmarks(n);
							return
					...
					if (q = b.splitBlock(l)) {
						...
						if (n || f)
							if (m(e)) b.moveToElementEditStart(b.getTouchedStartNode());
							else {
								if (a) {
								...
								if (h = q.elementPath)
									for (e = 0, g = h.elements.length; e < g; e++) {
										l = h.elements[e];
								...
								!CKEDITOR.env.ie || !n || f && a.getChildCount() || (b.moveToElementEditStart(f ? a : d), b.select());
			...
			enterBr: function(a, e, b, g) {
				if (b = b || y(a)) {
					var m = b.document,
						...
						f = n.block,
						p = f && n.block.getName();
					g || "li" != p ? (!g && h && w.test(p) ? (h = f.getDirection()) ? (m = m.createElement("div"), m.setAttribute("dir", h), m.insertAfter(f), b.setStart(m, 0)) : (m.createElement("br").insertAfter(f), CKEDITOR.env.gecko && m.createText("").insertAfter(f), b.setStartAt(f.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == p && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? m.createText("\r") : m.createElement("br"), b.deleteContents(), b.insertNode(a), CKEDITOR.env.needsBrFiller ? (m.createText("﻿").insertAfter(a), h && (f || n.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", b.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : b.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), b.collapse(!0), b.select(), b.scrollIntoView()) : r(a, e, b, g)
				}
			}
		};
	...
	CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
		popup: function(e, a, b, d) {
			...
			d = (d || "location\x3dno,menubar\x3dno,toolbar\x3dno,dependent\x3dyes,minimizable\x3dno,modal\x3dyes,alwaysRaised\x3dyes,resizable\x3dyes,scrollbars\x3dyes") + ",width\x3d" + a + ",height\x3d" + b + ",top\x3d" + f + ",left\x3d" + g;
	...
	(function() {
		...
		l.prototype = {
			...
			attachRequestListeners: function() {
				...
				d.onload = function() {
					b.update();
					if ("abort" != b.status)
						if (b.uploaded = b.uploadTotal, 200 > d.status || 299 < d.status) b.message = b.lang.filetools["httpError" + d.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1", d.status)), b.changeStatus("error");
						else {
							for (var a = {
									fileLoader: b
		...
		CKEDITOR.tools.extend(CKEDITOR.fileTools, {
			...
			getUploadUrl: function(a, c) {
				...
				return c && a[c + "UploadUrl"] ? a[c + "UploadUrl"] : a.uploadUrl ? a.uploadUrl : c && a["filebrowser" + b(c, 1) + "UploadUrl"] ? a["filebrowser" + b(c, 1) + "UploadUrl"] + "\x26responseType\x3djson" : a.filebrowserUploadUrl ? a.filebrowserUploadUrl + "\x26responseType\x3djson" : null
			},
	...
	(function() {
		...
		function q() {
			...
			var d = b.config["filebrowser" + k(a.getName()) + "WindowWidth"] || b.config.filebrowserWindowWidth || "80%",
			...
			if (c && c.length)
				for (var e, g = c.length; g--;)
					if (e = c[g], "hbox" != e.type && "vbox" != e.type && "fieldset" != e.type || l(a, b, d, e.children), e.filebrowser)
						...
						} else if ("QuickUpload" == e.filebrowser.action && e["for"] && (f = e.filebrowser.url, void 0 === f && (f = a.config["filebrowser" + k(b) + "UploadUrl"], void 0 === f && (f = a.config.filebrowserUploadUrl)), f)) {
				var h = e.onClick;
	...
	(function() {
		function m(a) {
			...
			CKEDITOR.env.ie && !CKEDITOR.env.edge && b.enterMode != CKEDITOR.ENTER_P ? f("p") : CKEDITOR.env.edge && 15 > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && f("div");
			...
			proto: {
				setData: function(a, f) {
					...
					if (f) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady");
						...
						d ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), h && (a = a.replace(/<head[^>]*?>/, "$\x26" + h)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = e + a) : a = c.docType + '\x3chtml dir\x3d"' + c.contentsLangDirection + '" lang\x3d"' + (c.contentsLanguage || b.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + h + g + "\x3c/head\x3e\x3cbody" + (c.bodyId ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
	...
	(function() {
		function w(f) {
			...
			for (var k = this, q = this.database, p = this.context, c, m = f.getSelection(), m = (m && m.getRanges()).createIterator(); c = m.getNextRange();) {
				...
				b && c.startContainer.type == CKEDITOR.NODE_ELEMENT && c.startContainer.getName() in p && (d = new CKEDITOR.dom.walker(c), d.evaluator = n, c.startContainer = d.next());
		...
		CKEDITOR.plugins.add("link", {
			...
			init: function(c) {
				...
				c.on("doubleclick", function(a) {
					...
					b && !b.isReadOnly() && (b.is("a") ? (a.data.dialog = !b.getAttribute("name") || b.getAttribute("href") && b.getChildCount() ? "link" : "anchor", a.data.link = b) : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, b) && (a.data.dialog = "anchor"))
				}, null, null, 0);
				c.on("doubleclick", function(a) {
					a.data.dialog in {
						link: 1,
	...
	(function() {
		...
		function la(a) {
			var c = a.doc,
				d = G('\x3cspan contenteditable\x3d"false" data-cke-magic-line\x3d"1" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', c),
				...
				a.on("paste", function(f) {
					...
					if (c && (e || d) && (!1 !== a.fire("pasteFromWord", g) || e)) {
						...
						var k = l(a, h, function() {
							if (k) a.fire("paste", b);
							else if (!a.config.pasteFromWordPromptCleanup || e || confirm(a.lang.pastefromword.confirmCleanup)) g.dataValue = CKEDITOR.cleanWord(g.dataValue, a), a.fire("afterPasteFromWord", g), b.dataValue = g.dataValue, !0 === a.config.forcePasteAsPlainText ? b.type = "text" : CKEDITOR.plugins.clipboard.isCustomCopyCutSupported || "allow-word" !== a.config.forcePasteAsPlainText || (b.type = "html");
							e = 0
						});
						k && f.cancel()
					}
	...
	CKEDITOR.plugins.add("scayt", {
				...
				f = function() {
					...
					b.attachListener(b, "focus", function(b) {
						...
						if ((d || b) && a._.savedSelection) {
							...
							for (var h = 0; h < b.length; h++) k = b[h], "string" === typeof k.startContainer.$.nodeValue && (c = k.startContainer.getText().length, (c < k.startOffset || c < k.endOffset) && a.unlockSelection(!1))
						}
					}, this, null, -10)
				},
				g = function() {
		...
		menuGenerator: function(a, c) {
			...
			l ? (b = b.scayt, k = c.getAttribute(d.getScaytNodeAttributeName()), d.fire("getSuggestionsList", {
				lang: g,
				word: k
			}), e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, l)) : m && (b = b.grayt, e = c.getAttribute(d.getGraytNodeAttributeName()), d.getGraytNodeRuleAttributeName ? (k = c.getAttribute(d.getGraytNodeRuleAttributeName()), d.getProblemDescriptionText(e, k, g)) : d.getProblemDescriptionText(e, g), n = d.getProblemDescriptionText(e, k, g), b.grayt_problemdescription && n && (n = n.replace(/([.!?])\s/g, "$1\x3cbr\x3e"), b.grayt_problemdescription.label = n), d.fire("getGrammarSuggestionsList", {
				lang: g,
				phrase: e,
				rule: k
		...
		CKEDITOR.plugins.add("stylescombo", {
			...
			init: function(c) {
				...
				c.on("stylesSet", function(a) {
					if (a = a.data.styles) {
						for (var b, h, d, e = 0, n = a.length; e < n; e++)(b = a[e], c.blockless && b.element in CKEDITOR.dtd.$block || "string" == typeof b.type && !CKEDITOR.style.customHandlers[b.type] || (h = b.name, b = new CKEDITOR.style(b), c.filter.customConfig && !c.filter.check(b))) || (b._name = h, b._.enterMode = l.enterMode, b._.type = d = b.assignedTo || b.type, b._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), f[h] = b, k.push(b), m.push(b));
						k.sort(function(a, b) {
				...
				c.ui.addRichCombo("Styles", {
					...
					init: function() {
						var a, b, c, d, e, f;
						e = 0;
						for (f = k.length; e < f; e++) a = k[e], b = a._name, d = a._.type, d != c && (this.startGroup(g["panelTitle" + String(d)]), c = d), this.add(b, a.type == CKEDITOR.STYLE_OBJECT ? b : a.buildPreview(), b);
						this.commit()
					},
					onClick: function(a) {
						c.focus();
							...
							right: function(c) {
								if (c.styles) {
									...
									if (c.styles.border) a = CKEDITOR.tools.style.parse.border(c.styles.border);
										...
										var b = c.styles;
										b["border-left"] && b["border-left"] === b["border-right"] && b["border-right"] === b["border-top"] && b["border-top"] === b["border-bottom"] && (a = CKEDITOR.tools.style.parse.border(b["border-top"]))
									}
	...
	(function() {
			...
			for (var g = d.getRanges(), k = 0; k < g.length; k++) {
				...
				if (h.collapsed)(h = h.getCommonAncestor().getAscendant({
					...
					var h = new CKEDITOR.dom.walker(h),
						l;
					for (h.guard = c; l = h.next();) l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
						td: 1,
						th: 1
			...
			if (d instanceof CKEDITOR.dom.selection) {
				...
				for (d = a; d <= g; d++) {
					for (var k = e[d], h = new CKEDITOR.dom.element(c.$.rows[d]), l = 0; l < k.length; l++) {
						var m = new CKEDITOR.dom.element(k[l]),
				...
				a = new CKEDITOR.dom.element(e[g + 1] || (0 < a ? e[a - 1] : null) || c.$.parentNode);
		...
		function y(d) {
			...
			for (d = g.length; m < d; m++)
				for (var n = 0, p = g[m].length; n < p; n++) void 0 === k && g[m][n] == e.$ && (k = n), g[m][n] == a.$ && (h = n);
			for (m = k; m <= h; m++)
			...
			l.length == d && (b[0].moveToPosition(c, CKEDITOR.POSITION_AFTER_END), b[0].select(), c.remove());
			return k
		}
		...
		function x(d, f, b) {
			...
			for (f = 0; f < c.length; f++) {
				...
				var t = a.getParent(),
					...
					p = Math.max(p, B - m + v);
				n = Math.max(n, t - l + z);
				b || (v = a, (z = v.getBogus()) && z.remove(), v.trim(), a.getChildren().count() && (t == r || !y || y.isBlockBoundary && y.isBlockBoundary({
					br: 1
				}) || (r = u.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !r || r.is && r.is("br") || u.append("br")), a.moveChildren(u)), f ? a.remove() : a.setHtml(""));
				r = t
			}
			if (b) return n * p == w;
			u.moveChildren(d);
			...
			n >= k ? d.removeAttribute("colSpan") : d.$.colSpan = p;
	...
	(function() {
		...
		function w(a) {
			...
			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				...
				(f || k) && L(e, f || k, a);
				"mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(h, k)) && K(e), m = {
					active: !1
		...
		q.prototype.insertRow = function(a, b, c) {
			...
			for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, g = c ? [] : this.cells.all, h, k = 0; k < a; k++) h = F(c ? this.cells.all : g, b), h = CKEDITOR.tools.array.filter(h.find("td, th").toArray(), function(a) {
			...
			pasteTable: function(a, b, c) {
				...
				for (l = 0; l < c.length; l++)
					for (k = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++)
						if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] && b[l][p] ? new CKEDITOR.dom.element(b[l][p]) : null, f && !f.getCustomData("processed")) {
			...
			keyboardIntegration: function(a) {
				...
				c.attachListener(c, "keypress", function(d) {
					var c = a.getSelection(),
						...
						h;
					if (!a.readOnly && c && c.isInTable() && c.isFake && g && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
						d = c.getRanges();
	...
	(function() {
		...
		function p(a, d) {
			...
			this.lineTpl = (new CKEDITOR.template('\x3cdiv data-cke-lineutils-line\x3d"1" class\x3d"cke_reset_all" style\x3d"{lineStyle}"\x3e\x3cspan style\x3d"{tipLeftStyle}"\x3e\x26nbsp;\x3c/span\x3e\x3cspan style\x3d"{tipRightStyle}"\x3e\x26nbsp;\x3c/span\x3e\x3c/div\x3e')).output({
				lineStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, t, this.lineStyle, !0)),
		...
		n.prototype = {
			locate: function() {
				function a(a, b) {
					...
					return c && l(c) ? (a.siblingRect = c.getClientRect(), b == CKEDITOR.LINEUTILS_BEFORE ? (a.siblingRect.bottom + a.elementRect.top) / 2 : (a.elementRect.bottom + a.siblingRect.top) / 2) : b == CKEDITOR.LINEUTILS_BEFORE ? a.elementRect.top : a.elementRect.bottom
				}
				return function(d) {
					var b;
					this.locations = {};
					for (var c in d) b = d[c], b.elementRect = b.element.getClientRect(), b.type & CKEDITOR.LINEUTILS_BEFORE && this.store(c, CKEDITOR.LINEUTILS_BEFORE, a(b, CKEDITOR.LINEUTILS_BEFORE)), b.type & CKEDITOR.LINEUTILS_AFTER && this.store(c, CKEDITOR.LINEUTILS_AFTER, a(b, CKEDITOR.LINEUTILS_AFTER)), b.type & CKEDITOR.LINEUTILS_INSIDE && this.store(c, CKEDITOR.LINEUTILS_INSIDE, (b.elementRect.top + b.elementRect.bottom) / 2);
		...
		p.prototype = {
			...
			getStyle: function(a, d) {
				...
				this.inline ? e.left = b.elementRect.left - this.rect.relativeX : (0 < b.elementRect.left ? e.left = this.rect.left + b.elementRect.left : (e.width += b.elementRect.left, e.left = this.rect.left), 0 < (b = e.left + e.width - (this.rect.left + this.winPane.width)) && (e.width -= b));
		...
		CKEDITOR.plugins.widgetselection = {
			...
			addFillers: function(a) {
				...
				if (!this.isWholeContentSelected(a) && 0 < a.getChildCount()) {
					var d = a.getFirst(e),
						c = a.getLast(e);
					d && d.type == CKEDITOR.NODE_ELEMENT && !d.isEditable() && (this.startFiller = this.createFiller(), a.append(this.startFiller, 1));
			...
			removeFiller: function(a, b) {
				if (a) {
					...
					a.remove();
					g && 0 < g.length && g != this.fillerContent ? (b.insertHtmlIntoRange(g, d.getSelection().getRanges()[0]), f.setStartAt(b.getChild(b.getChildCount() - 1), CKEDITOR.POSITION_BEFORE_END), d.getSelection().selectRanges([f])) : e && (c ? f.setStartAt(b.getFirst().getNext(), CKEDITOR.POSITION_AFTER_START) : f.setEndAt(b.getLast().getPrevious(), CKEDITOR.POSITION_BEFORE_END), b.editor.getSelection().selectRanges([f]))
				}
			},
	...
	(function() {
		...
		function U(a) {
			...
			return {
				...
				iterator: function(a) {
					var f, h, l, k, m;
					if ("data-cke-widget-wrapper" in a.attributes) return (a = a.getFirst(g.isParserWidgetElement)) && b.push([a]), !1;
		...
		function M(a) {
			...
			b.on("contentDom", function() {
				...
				c.attachListener(d, "mousedown", function(c) {
					...
					f = 0;
					e && (e.inline && d.type == CKEDITOR.NODE_ELEMENT && d.hasAttribute("data-cke-widget-drag-handler") ? (f = 1, a.focused != e && b.getSelection().removeAllRanges()) : g.getNestedEditable(e.wrapper, d) ? e = null : (c.data.preventDefault(), CKEDITOR.env.ie || e.focus()))
				});
		...
		function I(a) {
			...
			b.on("paste", function(a) {
				...
				a.range && (a = g.getNestedEditable(b.editable(), a.range.startContainer)) && (a = CKEDITOR.filter.instances[a.data("cke-filter")]) && b.setActiveFilter(a)
			});
		...
		function C(a) {
			...
			return {
				...
				commit: function() {
					...
					for (f && (h = a.focused) && t(a, h); h = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, h), 1), h.isInited() && (g = h.editor.checkDirty(), h.setSelected(!1), !g && h.editor.resetDirty());
					f && e && (g = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", {
						widget: e
					}), e.setFocused(!0), !g && a.editor.resetDirty());
		...
		function Q(a, b) {
			...
			a.on("key", function(b) {
				...
				if (13 == b) a.edit();
					...
					if (b in ga || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return
				}
				return !1
			}, null, null, 999);
		...
		function ha() {
			...
			CKEDITOR.style.addCustomHandler({
				...
				removeStylesFromSameGroup: function(a) {
					...
					f = a.elementPath();
					if (this.checkApplicable(f, a))
						for (var g = 0, k = this.group.length; g < k; g++) {
					...
					init: function() {
						...
						k.on("update", function(b) {
							...
							if (d.wrapper && d.wrapper.getParent()) {
								a.fire("lockSnapshot");
								b = "on" + f(k.status);
								if ("abort" === k.status || "function" !== typeof d[b] || !1 !== d[b](k)) e = "cke_upload_" + k.status, d.wrapper && e != g && (g && d.wrapper.removeClass(g), d.wrapper.addClass(e), g = e), "error" != k.status && "abort" != k.status || a.widgets.del(d);
								a.fire("unlockSnapshot")
				...
				if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
					...
					e && (a.addUploadWidget(c, "uploadimage", {
						...
						onUploaded: function(b) {
							...
							this.replaceWith('\x3cimg src\x3d"' + b.url + '" width\x3d"' + (b.responseData.width || a.naturalWidth) + '" height\x3d"' + (b.responseData.height || a.naturalHeight) + '"\x3e')
						}
