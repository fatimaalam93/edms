	...
	<div class="col-md-4">
		...
		<div class="card">
			...
			<div class="card-block">
				...
				@else
				{{ Form::open(['class' => '', 'files' => true, 'url' => 'sector',
				'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
				@endif
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label class="col-form-label"><span class="required"> * </span> Sector Name </label>
							<input type="text" class="form-control {{ $errors->has('sector_name') ? ' is-invalid' : '' }}" name="sector_name" id="name" placeholder="Sector Name" value="{{isset($editData)? $editData->sector_name : '' }}">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{url('sector/'.$value->id.'/edit')}}" title="Edit"><button type="button" class="btn btn-info action-icon"><i class="fa fa-edit"></i></button></a>
									<a class="modalLink" title="Delete" data-modal-size="modal-md" href="{{url('deleteSectorView', $value->id)}}">
