<title>EDMS</title>
  <!--[if lt IE 10]>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/pages/data-table/extensions/buttons/css/buttons.dataTables.min.css')}}">
  ...
  <!-- start css for select2 dropdown -->
