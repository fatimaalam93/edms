			...
			<div class="col-md-8 offset-md-2 pt-4">
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control  {{ $errors->has('document_type_code') ? ' is-invalid' : '' }}" value="{{ old('document_type_code') }}" name="document_type_code" />
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control {{ $errors->has('owner') ? ' is-invalid' : '' }}" value="{{ old('owner') }}" name="owner"/>
						@if ($errors->has('owner'))
						<span class="invalid-feedback" role="alert" >
				...
				<div class="row">
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control {{ $errors->has('speciality') ? ' is-invalid' : '' }}" value="{{ old('speciality') }}" name="speciality"/>
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control {{ $errors->has('consultant') ? ' is-invalid' : '' }}" value="{{ old('consultant') }}" name="consultant"/>
				...
				<div class="row">
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control {{ $errors->has('acl') ? ' is-invalid' : '' }}" value="{{ old('acl') }}" name="acl"/>
						@if ($errors->has('acl'))
						<span class="invalid-feedback" role="alert" >
