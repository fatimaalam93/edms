				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control {{ $errors->has('designation_name') ? ' is-invalid' : '' }}" name="designation_name" id="name" placeholder="Designation Name" value="{{isset($editData)? $editData->designation_name : old('designation_name') }}">

							@if ($errors->has('designation_name'))
							<span class="invalid-feedback" role="alert">
								<span class="messages"><strong>{{ $errors->first('designation_name') }}</strong></span>
							</span>
							@endif
						</div>
					</div>
